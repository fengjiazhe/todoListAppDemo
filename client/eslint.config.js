...
export default defineConfig([
  {
    ...
    languageOptions: {
      ecmaVersion: 6, // 对应 es6: true
      sourceType: "module",
      globals: {
        ...globals.browser,
        node: true, // 对应 node: true
      },
      parser: require("@babel/eslint-parser"), // 替换 babel-eslint 使用新版解析器
    },
    settings: {
      import: {
        resolver: {
  ...
  // Vue 相关规则
  {
    ...
    ...pluginVue.configs["flat/recommended"], // 推荐使用 recommended 而不是 essential
  },
]);